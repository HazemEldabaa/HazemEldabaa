...
- API Deployment & Interactive Front-end: [Immo-Eliza-Deployment](https://github.com/HazemEldabaa/immo-eliza-deployment)

- Pretty cool right? Now watch me automate the whole process in an Airflow Pipeline: [Immo-Eliza-Automated-Pipeline](https://github.com/HazemEldabaa/immo-eliza-automated-pipeline)
